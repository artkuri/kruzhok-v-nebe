...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      variant === "default" && "border-gray-100 bg-white text-gray-900",
      variant === "destructive" && "border-red-100 bg-red-50 text-red-900",
      variant === "success" && "border-emerald-100 bg-emerald-50 text-emerald-900",
      className
    )}
    {...props}
  />
...
export function Toaster() {
  ...
  return (
    <ToastProvider>
      {toastList.map(({ id, title, description, variant }) => (
