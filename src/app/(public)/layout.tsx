        ...
        <div className="page-container py-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">+7 (XXX) XXX-XX-XX</p>
              <p className="text-sm text-gray-500">info@kruzhok.ru</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Режим работы</h3>
              <p className="text-sm text-gray-500">Вт–Пт: 17:00–21:00</p>
              <p className="text-sm text-gray-500">Сб: 11:00–15:00</p>
            </div>
          </div>
